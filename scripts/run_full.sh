...
echo -e "  Las credenciales se generan automáticamente en el primer inicio."
echo -e "  Revise el archivo primer_inicio.txt en el directorio de datos de la aplicación."
echo -e ""
