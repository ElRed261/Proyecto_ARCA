...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            audit::audit_browse_stations,
            audit::audit_browse_years,
            audit::audit_browse_months,
            audit::audit_browse_days,
            audit::audit_load_observation,
            audit::audit_mark_error,
            audit::audit_unmark_error,
