...
echo -e "  Las credenciales del primer inicio han sido generadas de forma aleatoria."
echo -e "  Por favor consulte el archivo 'primer_inicio.txt' en la ruta de datos:"
echo -e "  ~/.local/share/com.arca.meteorologico/primer_inicio.txt (o directorio equivalente de la app)"
echo -e ""
